...
1. **Verification** of the remaining 4 drafts (drafter ≠ verifier), one verdict at a time. This is the binding constraint the sprint exposed; it does not compress. → ~1–2 per run.
